 ...
 *
 * Copied verbatim from BLEHIDKeys.h in HijelHID_BLEKeyboard. The ((uint8_t))
 * casts are load-bearing: they are what makes AirKeyboard::press() resolve to
 * the keycode overload rather than an integer-promoted one.
 *
