 ...
 * Used with AirConsumer::press() / release() / tap().
 *
 * These are 16-bit usage IDs. AirConsumer's descriptor declares Logical
 * Maximum 0x3FF, so any usage up to 0x3FF works without a descriptor change —
 * including Consumer Page usages not listed here.
 *
 * Copied from BLEHIDMediaKeys.h in HijelHID_BLEKeyboard.
 *
